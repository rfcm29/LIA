...
class ReservasDecorrerController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $listaReservas= [];
        foreach (Reserva::all()->where("isAceite","=",true)->where("isConcluido","=",false) as $reserva) {
