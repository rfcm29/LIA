...
class KitsController extends Controller
{
    public function index($id){
        ...
        if($this->hasSession()){
            ...
            if(request('search')){
                ...
                $kits = Kit::where('kit_category_id', $id)->get();
            }
        }
    ...
    private function filteredKits($id){
        $kits = Kit::where('kit_category_id', $id)->doesntHave('reserves')
                ->orWhere('kit_category_id', $id)->whereDoesntHave('reserves', function(Builder $query){
