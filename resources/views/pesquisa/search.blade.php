      ...
      <form action="/searchItemsAndKits" method="POST">
        ...
        @if (session('datas'))
              <div class="row">
                ...
                <div class="col-md-12">
                <label for="datas">Pesquisa para datas entre {{session('datas')[0]}} e {{session('datas')[1]}} </label>
                </div>
              </div>
        ...
        <div class="col-md-3">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <img class="img-responsive" src="{{$item[1]->fotografia_caminho}}" alt="..." width="240" height="200">
              <p></p>
              <div class="panel-body">
      ...
      @foreach ($kitsAtributos as $kit)
        ...
        <div class="col-md-3">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <img class="img-responsive" src="{{$kit[1]->fotografia_caminho}}" alt="..." width="240" height="200">
              <p></p>
              <div class="panel-body">
                <h4>{{$kit[0]->id_ipvc}}</h4>
              </div>
              <div class="row">
                ...
                <a href="/kits/{{$kit[0]->id}}" class="btn btn-primary" >Ver item</a>
