    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <div class="x_content">
          ...
          <!-- form -->
          <form  method="POST" action="/kits/{{$kits->id}}" class="form-horizontal form-label-left">
            @method('PATCH')
            @csrf
            ...
            <div class="form-group">
                  ...
                  <input type="text"name="name" class="form-control col-md-7 col-xs-12" value="{{$kits->name}}">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="number" name="preco" class="form-control col-md-7 col-xs-12" min="1" value="{{$kits->preco}}">
            ...
            <!-- campo da quantidade -->
            <div class="form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12"> Quantidade de kits a inserir <span style="color:red">*</span></label>
              <div class="col-md-6 col-sm-6 col-xs-12">                         
