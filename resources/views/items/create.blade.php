              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <!-- form -->
                    <form  method="POST" action="/items" class="form-horizontal form-label-left" enctype="multipart/form-data">
                        @csrf
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="number" name="preco" step="0.01" class="form-control col-md-7 col-xs-12" min="1">
                            <span id="msg_ipvcnumber" name="msg" style="color:red"></span>
                          </div>
                        </div>
                      -->
